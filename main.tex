...
\title{Async HasChor: Functional Asynchronous Choreographic Programming}
...
In this paper, we present Async HasChor, an extension that adds asynchronous communication to the library-level functional choreographic programming language HasChor.
%
